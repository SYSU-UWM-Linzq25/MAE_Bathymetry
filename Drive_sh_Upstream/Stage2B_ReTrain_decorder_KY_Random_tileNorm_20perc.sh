#!/bin/bash
#SBATCH -J mae_KY_dec20
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 10
##SBATCH -t 12:00:00
#SBATCH -o /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_KY_dec20_%j.out
#SBATCH -e /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_KY_dec20_%j.out
...
# ===== KY full pool =====
KY_ALL=$ROOT/splits/smoke_small_1000/global/holdout_KY.txt

# ===== split output =====
SPLIT_ROOT=$ROOT/splits/KY_task2B_decoder20
mkdir -p "$SPLIT_ROOT"

KY_TRAIN=$SPLIT_ROOT/ky_train.txt
KY_VAL=$SPLIT_ROOT/ky_val.txt
...
# ===== training output =====
RUN_NAME=KY_task2B_decoder_random20
