#!/bin/bash
#SBATCH -J mae_KY_up_eval
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 10
##SBATCH -t 04:00:00
#SBATCH -o /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_KY_up_eval_%j.out
#SBATCH -e /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_KY_up_eval_%j.out
...
for MR in "${MASK_RATIOS[@]}"; do
  ...
  echo "======================================================"
  echo "[UPSTREAM] KY_val, mask_ratio=$MR"
  echo "[OUT] $OUTDIR"
  echo "======================================================"
