#!/bin/bash
#SBATCH -J mae_stage2_dec_eval
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 10
##SBATCH -t 02:00:00
#SBATCH -o /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_stage2_dec_eval_%j.out
#SBATCH -e /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Upstream_Model_ReTrain/log/mae_stage2_dec_eval_%j.out
...
# ===== 任务2A训练好的 decoder 模型 =====
DEC_OUT=$ROOT/runs/stage2_decoder_random20_fromValPool
...
OUTDIR=$EVAL_ROOT/stage2_decoder_mr_0.20
mkdir -p "$OUTDIR"

echo "======================================================"
echo "[DECODER] stage2_val, mask_ratio=0.20"
echo "[OUT] $OUTDIR"
echo "======================================================"
