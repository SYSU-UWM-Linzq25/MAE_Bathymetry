"""Unified relaxed-HiddenMask downstream trainer for single-channel DEM GeoTIFF tiles.

This isolated RELAX version exposes the same exact-pixel implementation for
both optimization_loss=normalized_mse and optimization_loss=meter_mae.
...
import models_mae
from engine_pretrain_unified_relax import train_one_epoch, evaluate_one_epoch
