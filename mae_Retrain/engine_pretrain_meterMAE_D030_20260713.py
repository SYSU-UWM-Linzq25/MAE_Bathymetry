...
def _meter_objective_components(
    ...
    """Return differentiable meter-space MAE plus exact metric components.
...
def _finalize_exact_meter_stats(stats, sums, optimization_loss: str):
    ...
    # code remains meaningful. For meter_mae it is the exact global pixel MAE.
