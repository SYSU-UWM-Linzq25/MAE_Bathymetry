#!/usr/bin/env bash
# NUMBER-ALIGNED NEW FAMILY COPY: G026_run_NormThenMeter_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260727.sh
# TEMPLATE SOURCE: G031_run_MeterOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260714.sh
# NUMBER-ALIGNED NAME: G026_run_MeterOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260714.sh
# ORIGINAL BACKUP NAME: G011_run_meterMAE_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_F051Stable_20260714.sh
...
SCRIPT=${SCRIPT:-$WORK/script/G025_build_NormThenMeter_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260727.py}

PRED_ROOT=${PRED_ROOT:-/tank/data/SFS/xinyis/data/bathymetry/Processed_Results/FullRiver_Predictions_G001_NormThenMeter_D001NoDataSafe}
ERROR_ROOT=${ERROR_ROOT:-/tank/data/SFS/xinyis/data/bathymetry/Processed_Results/FullRiver_GT_Error_G002_NormThenMeter_D001NoDataSafe}
...
OUT_DIR=${OUT_DIR:-/tank/data/SFS/xinyis/data/bathymetry/Processed_Results/FullRiver_WebMap_G025_NormThenMeter_Holdout_1m_WhiteNoBasemap_Probe}
OUT_HTML=${OUT_HTML:-G025_meterMAE_dashboard_1m_white_probe_F051Stable.html}
ZIP_NAME=${ZIP_NAME:-G025_meterMAE_dashboard_1m_white_probe_F051Stable_package.zip}
...
EXPERIMENTS=${EXPERIMENTS:-"holdout_CA_D005Stage2NormThenMeter_FromNorm_D001NoDataSafe holdout_CO_D005Stage2NormThenMeter_FromNorm_D001NoDataSafe holdout_Santiam_D005Stage2NormThenMeter_FromNorm_D001NoDataSafe"}
...
echo "============================================================"
echo "G011 NormThenMeter dashboard copied from the known-successful F051/F052 implementation"
