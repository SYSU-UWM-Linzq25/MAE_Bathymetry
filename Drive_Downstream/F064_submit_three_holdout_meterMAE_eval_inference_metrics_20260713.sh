...
EVAL_SCRIPT=${EVAL_SCRIPT:-$SCRIPT_DIR/E061_run_v4_meterMAE_train_val_core_pixel_eval_20260713.sh}
INFER_SCRIPT=${INFER_SCRIPT:-$SCRIPT_DIR/F061_run_fullriver_inference_meterMAE_TileAvgVRT_20260713.sh}
METRIC_SCRIPT=${METRIC_SCRIPT:-$SCRIPT_DIR/F063_run_fullriver_gt_error_uniquePixel_MeterMAE_20260713.sh}
