#!/bin/bash
#SBATCH -J eval_s4_val_lcc
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 10
#SBATCH -t 08:00:00
#SBATCH -o /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/logs/eval_s4_val_%j.out
#SBATCH -e /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/logs/eval_s4_val_%j.out
...
OUT=$WORK/eval_stage4_bathy_finalmask_holdout_${SAFE_VAL}/val_best_tilenormVis_std${STD_SCALE//./p}
mkdir -p "$OUT" "$WORK/logs"

export PYTHONPATH="$CODE${PYTHONPATH:+:$PYTHONPATH}"

echo "=== Stage4 final-mask LCC exact VAL evaluation ${SLURM_JOB_ID:-local} on $(hostname) ==="
date
...
date
echo "=== DONE Stage4 VAL evaluation ==="
