#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: E004_eval_zeroNDfix_best_exact_pixel.sh
# ORIGINAL BACKUP NAME: E021b_evaluate_zeroNDfix_best_exact_pixel.sh
...
EVAL_PY=$WORK/script/E003_evaluate_stage4_nodata_core_per_tile.py
if [[ -f "$WORK/script/E003_evaluate_stage4_nodata_core_per_tile_fixed.py" ]]; then
    EVAL_PY=$WORK/script/E003_evaluate_stage4_nodata_core_per_tile_fixed.py
fi
