#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: F033_run_fullriver_gt_error_MeterOnly_UniquePixel_20260713.sh
# ORIGINAL BACKUP NAME: F063_run_fullriver_gt_error_uniquePixel_MeterMAE_20260713.sh
...
SCRIPT=${SCRIPT:-$WORK/script/F032_fullriver_gt_error_MeterOnly_UniquePixel_20260713.py}
