#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: F023_run_fullriver_gt_error_NormOnly_20260710.sh
# ORIGINAL BACKUP NAME: F021_run_fullriver_gt_error_tilevrt_CoreFinalLossOnly_20260710.sh
...
SCRIPT=${SCRIPT:-$WORK/script/F022_fullriver_gt_error_NormOnly_UniqueCompatible_20260710.py}
