#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: G031_run_MeterOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260714.sh
...
SCRIPT=${SCRIPT:-$WORK/script/G030_build_MeterOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260714.py}
