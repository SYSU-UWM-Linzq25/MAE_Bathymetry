#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: E005b_evaluate_allRiverCanonicalND_best_predictionOnly_coreBox.sh
# ORIGINAL BACKUP NAME: E031b_evaluate_allRiverCanonicalND_best_predictionOnly_coreBox.sh
...
GENERIC=$WORK/script/E005a_eval_stage4_best_val_predictionOnly_coreBox.sh
