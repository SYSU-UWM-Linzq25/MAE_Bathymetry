...
#
# Usage:
#   bash E042_run_crossval_suspicious_summary.sh
#
# Optional:
...
#   SKIP_FOLDS="OR_SantiamRiverTB_Topobathy_1_D23" bash E042_run_crossval_suspicious_summary.sh
# ============================================================

ROOT=/tank/data/SFS/xinyis/data/bathymetry/MAE-Topography
WORK=$ROOT/Downstream_Task_Bathy
CV_ROOT=$WORK/cross_validation
PY=$WORK/script/E040_analyze_crossval_evaluations_suspicious_tiles.py
