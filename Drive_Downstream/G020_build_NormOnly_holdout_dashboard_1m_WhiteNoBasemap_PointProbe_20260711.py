#!/usr/bin/env python3
# NUMBER-ALIGNED NAME: G020_build_NormOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260711.py
# ORIGINAL BACKUP NAME: F051_build_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260711.py
