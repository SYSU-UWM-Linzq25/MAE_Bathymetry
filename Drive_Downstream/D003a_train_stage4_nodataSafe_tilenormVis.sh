...
#SBATCH -c 8
#SBATCH -t 7-00:00:00
#SBATCH -o /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/logs/train_s4_ndsafe_vis_%j.out
#SBATCH -e /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/logs/train_s4_ndsafe_vis_%j.out
...
RUN_NAME=stage4_bathy_finalmask_holdout_${SAFE_VAL}_exact_freeze_decoder_tilenormVis_nodataSafe_minvis${MIN_VISIBLE_PATCH_RATIO//./p}_std${STD_SCALE//./p}_1m_e${END_EPOCH}
...
for key in \
  ...
  tile_norm_visible_only tile_norm_std_scale nodata nodata_threshold min_valid_visible_patch_ratio; do
