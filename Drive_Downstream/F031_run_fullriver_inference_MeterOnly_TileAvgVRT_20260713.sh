#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: F031_run_fullriver_inference_MeterOnly_TileAvgVRT_20260713.sh
# ORIGINAL BACKUP NAME: F061_run_fullriver_inference_meterMAE_TileAvgVRT_20260713.sh
...
SCRIPT=${SCRIPT:-$WORK/script/F030_fullriver_predict_MeterOnly_TileAvgVRT_CoreFinalLossOnly_20260713.py}
