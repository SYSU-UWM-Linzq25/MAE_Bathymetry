#!/usr/bin/env bash
#SBATCH -J D027_s2_meter_std_from_norm
#SBATCH -p HydroIntel
...
exec >"$RUNTIME_LOG_DIR/D027_stage2_meter_std_from_norm_${RUNTIME_JOB_ID}.out" \
     2>"$RUNTIME_LOG_DIR/D027_stage2_meter_std_from_norm_${RUNTIME_JOB_ID}.err"
...
echo "============================================================"
echo "D027 std-strat Stage-2 meter-MAE from normalized-loss best"
