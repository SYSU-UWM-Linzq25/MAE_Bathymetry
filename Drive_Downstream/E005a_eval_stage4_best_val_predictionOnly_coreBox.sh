#!/bin/bash
# NUMBER-ALIGNED NAME: E005a_eval_stage4_best_val_predictionOnly_coreBox.sh
# ORIGINAL BACKUP NAME: E031_eval_stage4_best_val_predictionOnly_coreBox.sh
...
SCRIPT=$WORK/script/E005_evaluate_stage4_predictionOnly_coreBox.py
