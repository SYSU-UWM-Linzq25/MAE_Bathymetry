#!/usr/bin/env python3
# NUMBER-ALIGNED NAME: E020_evaluate_NormOnly_core_pixel_metrics_overlayvis_20260710.py
# ORIGINAL BACKUP NAME: E050_v2_dualmask_evaluate_core_pixel_metrics_D001NoDataSafe_overlayvis_20260710.py
# Compatibility rule: scientific logic and default data/result roots are preserved unless explicitly noted.
"""Evaluate MAE v2 dual-mask checkpoints with training-consistent core pixel metrics.
...
def main() -> None:
    ...
    summary = {
        ...
        "notes": [
            "rmse_m_core_loss_pixel uses Loss_Mask_Pixel AND core/prediction patch mask AND valid patch mask.",
            "rmse_norm_core_loss_pixel is the square-root of normalized MSE over the same pixels.",
