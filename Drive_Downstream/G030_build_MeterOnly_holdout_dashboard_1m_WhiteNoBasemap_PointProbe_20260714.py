...
# ORIGINAL BACKUP NAME: G010_build_meterMAE_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_F051Stable_20260714.py
...
G010 creates local XYZ raster tiles and displays them in Leaflet over an
...
def process_one(
    ...
    for layer_name in ("prediction", "gt", "error", "abs_error", "input_bathy", "hidden", "loss"):
        ...
        marker = layer_tiles / ".G010_complete.json"
    ...
    for layer_name, (probe_source, probe_resampling, probe_nodata, threshold) in probe_specs.items():
        ...
        marker = probe_dir / ".G010_probe_complete.json"
        signature = {
            "version": 1,
...
def write_readme(
    ...
    text = f"""G010 Meter-MAE Full-River High-Detail Dashboard
...
def main() -> None:
    ...
    (out_dir / "G010_manifest.json").write_text(json.dumps(manifest, indent=2), encoding="utf-8")
    write_readme(
        out_dir,
        args.out_html,
        args.zip_name,
