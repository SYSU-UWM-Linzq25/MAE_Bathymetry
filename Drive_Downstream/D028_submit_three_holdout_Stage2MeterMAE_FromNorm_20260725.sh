...
# D028: submit the three formal normalized -> meter Stage-2 holdout jobs.

SCRIPT_DIR=${SCRIPT_DIR:-/tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/script}
RUN_SCRIPT=${RUN_SCRIPT:-$SCRIPT_DIR/D026_v2_dualmask_holdout_Stage2MeterMAE_FromNorm_RuntimeLogSafe_20260725.sh}
...
echo "============================================================"
echo "Stage-2 normalized-loss -> meter-MAE jobs submitted"
echo "CA      : $jid_ca"
echo "CO      : $jid_co"
echo "Santiam : $jid_santiam"
echo
echo "Defaults:"
echo "  Stage-1 checkpoint = cross_validation_v2 ES-val_loss checkpoint-best"
...
echo
echo "Logs:"
echo "  /tank/data/SFS/xinyis/data/bathymetry/MAE-Topography/Downstream_Task_Bathy/cross_validation_v6_Stage2MeterMAE_FromNorm/logs/"
echo "============================================================"
