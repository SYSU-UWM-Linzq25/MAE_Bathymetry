...
# ORIGINAL BACKUP NAME: E061_run_v4_meterMAE_train_val_core_pixel_eval_20260713.sh
# Compatibility rule: scientific logic and default data/result roots are preserved unless explicitly noted.
#SBATCH -J E061_v4_meter_eval
#SBATCH -p HydroIntel
...
SCRIPT=${SCRIPT:-$WORK/script/E030_evaluate_MeterOnly_core_pixel_metrics_overlayvis_20260713.py}
...
exec >"$RUNTIME_LOG_DIR/E061_v4_meter_eval_${HOLDOUT_PRESET}_${RUNTIME_JOB_ID}.out" \
     2>"$RUNTIME_LOG_DIR/E061_v4_meter_eval_${HOLDOUT_PRESET}_${RUNTIME_JOB_ID}.err"
...
OUT_ROOT=${OUT_ROOT:-$RUN_DIR/eval_E060_v4_meterMAE_core_pixel_overlayvis}
...
echo "============================================================"
echo "E061 v4 meter-MAE train/val core-pixel evaluation"
date
