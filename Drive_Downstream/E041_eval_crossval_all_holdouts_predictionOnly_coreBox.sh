...
#
# Usage:
#   sbatch E041_eval_crossval_all_holdouts_predictionOnly_coreBox.sh
#
...
#     E041_eval_crossval_all_holdouts_predictionOnly_coreBox.sh
#
...
SCRIPT=${SCRIPT:-$WORK/script/E030_evaluate_stage4_predictionOnly_coreBox.py}
