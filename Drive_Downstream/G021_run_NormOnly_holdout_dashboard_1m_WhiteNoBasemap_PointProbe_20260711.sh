#!/usr/bin/env bash
# NUMBER-ALIGNED NAME: G021_run_NormOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260711.sh
# ORIGINAL BACKUP NAME: F052_run_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260711.sh
...
SCRIPT=${SCRIPT:-$WORK/script/G020_build_NormOnly_holdout_dashboard_1m_WhiteNoBasemap_PointProbe_20260711.py}
